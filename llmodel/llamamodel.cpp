...
bool LLamaModel::loadModel(const std::string &modelPath)
{
    ...
    d_ptr->params.use_mmap   = params.use_mmap  //llama_mmap_supported();  //params.use_mmap;
    d_ptr->params.use_mlock  = params.use_mlock //llama_mlock_supported(); //params.use_mlock;
